...
The first detailed example will be explained for European countries. Similar analyses for European regions and US states will follow.
...
```{r, echo = FALSE}
localfile <- "C:/data/_NASA_lights/F182013.v4c_web.stable_lights.avg_vis.tif"
...
Presentating the values of the selected variable requires mapping its name on the `fill` aestetics.
...
```{r, echo = FALSE}
png(filename = "pics/01_map_UE_raster.png", 
...
```{r}
png(filename = "pics/02_map_UE_raster_geometry.png", 
    width = 1000, height = 800)
plot(data_raster_EU)
plot(st_geometry(map_nuts0),
     add = TRUE) # added on previous map
...
```{r, echo=FALSE}
png(filename = "pics/03_map_UE_raster_geometry_masked.png", 
    width = 1000, height = 800)
plot(data_raster_EU)
plot(st_geometry(map_nuts0), 
     add = TRUE)
...
ggplot(map_nuts0) + 
  ...
  scale_fill_gradient(low = "black", high = "yellow") +
  guides(fill = FALSE) +
  theme_classic() -> map_lights_NUTS0

ggsave(plot = map_lights_NUTS0,
       filename = "pics/04_map_lights_NUTS0.png",
       width = 10, height = 8)
```
...
ggplot(map_nuts0_2,
  ...
  # labels with country codes added
  ...
  # title
  ggtitle("Night lights vs GDP in 2013 in EU countries") +
  theme_bw() -> scatter_lights_GDP_NUTS0
```  

```{r, echo=FALSE }
ggsave(plot = scatter_lights_GDP_NUTS0,
       filename = "pics/05_scatter_lights_GDP_NUTS0.png",
       width = 6, height = 6)
```
...
ggplot(map_nuts0_2,
  ...
  # labels with country codes added
  geom_label_repel(data = map_nuts0_2 %>% 
                     filter(population2013/1e+04 > 3 | lights2013/1e+06 > 3),
                   aes(label = NUTS_ID),
                   size = 5) +
  geom_text(x = 5.5, y = 3,
            size = 8,
  ...
  # title
  ggtitle("Night lights vs population in 2013 in EU countries") +
  theme_bw() -> scatter_lights_pop_NUTS0
```

```{r, echo=FALSE}
ggsave(plot = scatter_lights_pop_NUTS0,
       filename = "pics/06_scatter_lights_pop_NUTS0.png",
       width = 6, height = 6)
```

# Similar analysis for European NUTS 2 regions
...
```{r, echo=FALSE}
png(filename = "pics/10_mapa_UE_raster_geometry_NUTS2.png", 
    width = 1000, height = 800)
plot(data_raster_EU)
plot(st_geometry(map_nuts2),
     add = TRUE) # added on previous map
...
ggplot(map_nuts2) +
  ...
  scale_fill_gradient(low = "black", high = "yellow") +
  guides(fill = FALSE) +
  theme_classic() -> map_lights_nuts2

ggsave(plot = map_lights_nuts2,
       filename = "pics/12_map_lights_nuts2.png",
       width = 10)
```
...
ggplot(map_nuts2,
  ...
  geom_label_repel(data = map_nuts2 %>% 
                   ...
                   size = 5) +
  # title
  ggtitle("Night lights vs GDP in 2013 in EU regions (NUTS 2)") +
  theme_bw()
```
...
ggplot(map_nuts2,
  ...
  # title
  ggtitle("Night lights vs GDP in 2013 in EU regions (NUTS 2)") +
  theme_bw() -> scatter_lights_GDP_nuts2

ggsave(plot = scatter_lights_GDP_nuts2,
       filename = "pics/13_scatter_lights_GDP_nuts2.png",
       width = 6, height = 6)
```
...
ggplot(map_nuts2,
  ...
  geom_label_repel(data = map_nuts2 %>% 
                     filter(pop2013/1000 > 7 | lights2013/100000 > 10),
                   aes(label = NUTS_NAME),
                   size = 5) +
  # title
  ggtitle("Night lights vs population in 2013 in EU regions (NUTS 2)") +
  theme_bw()
```
...
ggplot(map_nuts2,
  ...
  # title
  ggtitle("Night lights vs population in 2013 in EU regions (NUTS 2)") +
  theme_bw() -> scatter_lights_pop_nuts2

ggsave(plot = scatter_lights_pop_nuts2,
       filename = "pics/14_scatter_lights_pop_nuts2.png",
       width = 6, height = 6)
```
...
```{r,echo=FALSE}
png(filename = "pics/10a_mapa_UE_raster_geometry_NUTS3.png", 
    width = 1000, height = 800)
plot(data_raster_EU)
plot(st_geometry(map_nuts3),
     add = TRUE) # added on previous map
...
ggplot(map_nuts3) +
  ...
  scale_fill_gradient(low = "black", high = "yellow") +
  guides(fill = FALSE) +
  theme_classic() -> map_ligts_nuts3

ggsave(plot = map_ligts_nuts3,
       filename = "pics/12a_map_lights_nuts3.png",
       width = 10)
```
...
ggplot(map_nuts3,
  ...
  geom_label_repel(data = map_nuts3 %>% 
                   ...
                   size = 5) +
  # title
  ggtitle("Night lights vs GDP in 2013 in EU regions (NUTS 3)") +
  theme_bw()
```
...
ggplot(map_nuts3,
  ...
  geom_label_repel(data = map_nuts3 %>% 
                   ...
                   size = 5) +
  ggtitle("Night lights vs GDP in 2013 in EU regions (NUTS 3)") +
  theme_bw() -> scatter_lights_GDP_nuts3

ggsave(plot = scatter_lights_GDP_nuts3,
       filename = "pics/13a_scatter_lights_GDP_nuts3.png",
       width = 8, 
       height = 8)
```
...
ggplot(map_nuts3,
  ...
  geom_label_repel(data = map_nuts3 %>% 
                   ...
                   aes(label = NUTS_NAME),
                   size = 5) +
  ggtitle("Night lights vs population in 2013 in EU regions (NUTS 3)") +
  theme_bw()
```
...
ggplot(map_nuts3,
  ...
  geom_label_repel(data = map_nuts3 %>% 
                   ...
                   size = 5) +
  ggtitle("Night lights vs population in 2013 in EU regions (NUTS 3)") +
  theme_bw() -> scatter_lights_pop_nuts3

ggsave(plot = scatter_lights_pop_nuts3,
       filename = "pics/14a_scatter_lights_pop_nuts3.png",
       width = 8, height = 8)
```
...
```{r, echo = FALSE}
png(filename = "pics/22_mapa_US_raster_geometry.png", 
    width = 1000, height = 800)
plot(data_raster_US)
plot(st_geometry(map_US2),
     add = TRUE)
...
```{r, echo=FALSE}
png(filename = "pics/23_mapa_US_raster_geometry_masked.png", 
    width = 1000, height = 800)
plot(data_raster_US)
plot(st_geometry(map_US2), 
     add = TRUE)
...
ggplot(map_US2) + 
  ...
  scale_fill_gradient(low = "black", high = "yellow") +
  guides(fill = FALSE) +
  theme_classic() -> map_ligts_US

ggsave(plot = map_ligts_US,
       filename = "pics/24_map_ligts_US.png",
       width = 10, height = 8)
```
...
ggplot(map_US2_2,
  ...
  # title
  ggtitle("Night lights vs GDP in 2013 in US states") +
  theme_bw()
```
...
ggplot(map_US2_2,
  ...
  # title
  ggtitle("Night lights vs GDP in 2013 in US states") +
  theme_bw() -> scatter_lights_GDP_US

ggsave(plot = scatter_lights_GDP_US,
       filename = "pics/25_scatter_lights_GDP_US.png",
       width = 6, height = 6)
```
...
ggplot(map_US2_2,
  ...
  # title
  ggtitle("Night lights vs population in 2013 in US states") +
  theme_bw()
```
...
ggplot(map_US2_2,
  ...
  # title
  ggtitle("Night lights vs population in 2013 in US states") +
  theme_bw() -> scatter_lights_pop_US

ggsave(plot = scatter_lights_pop_US,
       filename = "pics/26_scatter_lights_pop_US.png",
       width = 6, height = 6)
```